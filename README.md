...
1. To commit something to the repo first create a new branch (patch-%your username or name%-%the number of PRs you've already made% &rarr; patch-martin-6)
2. Add all changes you made with &rarr; `git add ...`
3. Run `yarn commit` and follow the instructions
4. Make a PR to DEV branch
